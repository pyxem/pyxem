...
pks = temp.find_peaks(interactive=False, threshold_abs=0.4, min_distance=5, get_intensity=True)
...
slic_vectors = (vectors.irow[vectors.icol[0] < 10]).to_markers(color="green",
                                                             sizes=5,
                                                             alpha=0.5)
...
# %%
slic_vectors = (vectors.irow[(vectors.icol[0] > 0) * (vectors.icol[0] < 10)]).to_markers(color="w",
                                                             sizes=5,
                                                             alpha=0.5)
s.plot()
s.add_marker([all_vectors, slic_vectors])
...
slic_vectors = vectors.irow[vect_magnitudes<20].to_markers(color="w",
                                                             sizes=5,
                                                             alpha=0.5)
s.plot()
s.add_marker([all_vectors, slic_vectors])
...
slic_vectors = (vectors.irow[vectors.icol["intensity"] < 0.5]).to_markers(color="w",
                                                             sizes=5,
                                                             alpha=0.5)
s.plot()
s.add_marker([all_vectors, slic_vectors])
