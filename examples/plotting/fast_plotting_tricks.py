...
Sometimes you want to quickly plot a diffraction pattern but things seem __slow__,
...
# :external+hyperspy:meth:`~.api.signals.BaseSignal.plot`:external+hyperspy:meth:`~.api.signals.BaseSignal.plot`
# `s.compute_navigator()` which will compute the navigator and store it in the signal. This will make plotting faster.
...
# :external+hyperspy:meth:`~.api.signals.LazySignal.compute_navigator` function of the signal and
