...
#
# 1. Precompute the navigator using the
# :meth:`hyperspy.api.signals.LazySignal.compute_navigator` method
...
# :meth:`hyperspy.api.signals.LazySignal.compute_navigator` method of the signal and
