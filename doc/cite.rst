...
If analysis using pyxem forms a part of published work please cite the work using the
...
In addition if you are releasing the data and code related to the work please add the
