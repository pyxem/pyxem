...
class TestIsEllipseGood:
    ...
    @mark.parametrize(
            "semi_len_ratio_lim,out", [(2.1, True), (1.5, False), (3, True)])
    ...
    @mark.parametrize(
            ...
            [(5, 3, 1, 2, 7, 2, True), (3, 3, 1, 2, 7, 2, False),
             (5, 5, 1, 2, 7, 2, False), (5, 2, 3, 2, 7, 2, True),
             (5, 2, 3, 5, 7, 2, False), (5, 2, 3, 5, 6, 2, False),
             (5, 3, 1, 3, 7, 1.5, False), (1, 9, 1, 5, 6, 1.1, False)])
    def test_many_different_ones(self, x, y, r, smin, smax, srl, out):
        model = ret.EllipseModel()
        model.params = ret._make_ellipse_model_params_focus(5, 3, 4, 6.5, 0.1)
        is_good = ret.is_ellipse_good(
                ellipse_model=model, data=None, xf=x, yf=y, rf_lim=r,
                semi_len_min=smin, semi_len_max=smax, semi_len_ratio_lim=srl)
        assert is_good == out
...
class TestGetEllipseModelRansacSingleFrame:
    ...
    def test_all_inliers(self):
        ...
        model_ransac, inliers = ret.get_ellipse_model_ransac_single_frame(
                data, xf=50, yf=55, rf_lim=2, semi_len_min=10, semi_len_max=25,
                semi_len_ratio_lim=2, min_samples=6, residual_threshold=10,
                max_trails=100)
        params0f = (xf, yf, a, b, r)
        params1f = ret._ellipse_model_centre_to_focus(
                *model_ransac.params, xf, yf)
        assert inliers.all()
    ...
    def test_xf(self):
        ...
        model_ransac0, inliers0 = ret.get_ellipse_model_ransac_single_frame(
                data, xf=xf0, yf=55, rf_lim=2, semi_len_min=19,
                semi_len_max=None, semi_len_ratio_lim=2, min_samples=5,
                residual_threshold=10, max_trails=300)
        params00f = (xf0, yf, a, b, r)
        params01f = ret._ellipse_model_centre_to_focus(
                *model_ransac0.params, xf0, yf)
        compare_model_params(params00f, params01f, abs=0.1)

        model_ransac1, inliers1 = ret.get_ellipse_model_ransac_single_frame(
                data, xf=xf1, yf=55, rf_lim=2, semi_len_min=19,
                semi_len_max=None, semi_len_ratio_lim=2, min_samples=5,
                residual_threshold=10, max_trails=300)
        params10f = (xf1, yf, a, b, r)
        params11f = ret._ellipse_model_centre_to_focus(
                *model_ransac1.params, xf1, yf)
    ...
    def test_yf(self):
        ...
        data = np.vstack((data0, data1))
        model_ransac0, inliers0 = ret.get_ellipse_model_ransac_single_frame(
                data, xf=50, yf=yf0, rf_lim=2, semi_len_min=19,
                semi_len_max=None, semi_len_ratio_lim=2, min_samples=5,
                residual_threshold=10, max_trails=300)
        params00f = (xf, yf0, a, b, r)
        params01f = ret._ellipse_model_centre_to_focus(
                *model_ransac0.params, xf, yf0)
        compare_model_params(params00f, params01f, abs=0.1)

        model_ransac1, inliers1 = ret.get_ellipse_model_ransac_single_frame(
                data, xf=50, yf=yf1, rf_lim=2, semi_len_min=19,
                semi_len_max=None, semi_len_ratio_lim=2, min_samples=5,
                residual_threshold=10, max_trails=300)
        params10f = (xf, yf1, a, b, r)
        params11f = ret._ellipse_model_centre_to_focus(
                *model_ransac1.params, xf, yf1)
        compare_model_params(params10f, params11f, abs=0.1)
    ...
    def test_rf_lim(self):
        ...
        data = ret.make_ellipse_data_points(xf, yf, a, b, r, nt=25)
        model_ransac0, inliers0 = ret.get_ellipse_model_ransac_single_frame(
                data, xf=50, yf=50, rf_lim=6, semi_len_min=15, semi_len_max=23,
                semi_len_ratio_lim=1.2, min_samples=5, residual_threshold=10,
                max_trails=100)
        params0f = (xf, yf, a, b, r)
        params1f = ret._ellipse_model_centre_to_focus(
                *model_ransac0.params, xf, yf)
        assert inliers0.all()
        compare_model_params(params0f, params1f, abs=0.1)

        model_ransac1, inliers1 = ret.get_ellipse_model_ransac_single_frame(
                data, xf=50, yf=50, rf_lim=3, semi_len_min=15, semi_len_max=23,
                semi_len_ratio_lim=1.2, min_samples=5, residual_threshold=10,
                max_trails=100)
    ...
    def test_semi_len_min(self):
        ...
        data = ret.make_ellipse_data_points(xf, yf, a, b, r, nt=25)
        model_ransac0, inliers0 = ret.get_ellipse_model_ransac_single_frame(
                data, xf=50, yf=55, rf_lim=2, semi_len_min=19,
                semi_len_max=None, semi_len_ratio_lim=2, min_samples=6,
                residual_threshold=10, max_trails=100)
        params0f = (xf, yf, a, b, r)
        params1f = ret._ellipse_model_centre_to_focus(
                *model_ransac0.params, xf, yf)
        assert inliers0.all()
        ...
        model_ransac1, inliers1 = ret.get_ellipse_model_ransac_single_frame(
                data, xf=50, yf=55, rf_lim=2, semi_len_min=25,
                semi_len_max=None, semi_len_ratio_lim=2, min_samples=6,
                residual_threshold=10, max_trails=100)
        assert model_ransac1 is None
    ...
    def test_semi_len_max(self):
        ...
        data = ret.make_ellipse_data_points(xf, yf, a, b, r, nt=25)
        model_ransac0, inliers0 = ret.get_ellipse_model_ransac_single_frame(
                data, xf=50, yf=55, rf_lim=2, semi_len_min=None,
                semi_len_max=25, semi_len_ratio_lim=2, min_samples=6,
                residual_threshold=10, max_trails=100)
        params0f = (xf, yf, a, b, r)
        params1f = ret._ellipse_model_centre_to_focus(
                *model_ransac0.params, xf, yf)
        ...
        model_ransac1, inliers1 = ret.get_ellipse_model_ransac_single_frame(
                data, xf=50, yf=55, rf_lim=2, semi_len_min=None,
                semi_len_max=15, semi_len_ratio_lim=2, min_samples=6,
                residual_threshold=10, max_trails=100)
        assert model_ransac1 is None
...
class TestGetEllipseModelRansac:
    ...
    def test_xc_yc(self):
        ...
        ellipse_array0, inlier_array0 = ret.get_ellipse_model_ransac(
                peak_array, xf=95, yf=115, rf_lim=20,
                semi_len_min=50, semi_len_max=65, semi_len_ratio_lim=1.2,
                min_samples=15, max_trails=20)
        ellipse_array1, inlier_array1 = ret.get_ellipse_model_ransac(
                peak_array, xf=10, yf=12, rf_lim=20,
                semi_len_min=50, semi_len_max=65, semi_len_ratio_lim=1.2,
                min_samples=15, max_trails=20)
    ...
    def test_semi_lengths(self):
        ...
        peak_array = mdtd._make_4d_peak_array_test_data(
                xf, yf, semi0, semi1, rot, nt=20)
        ellipse_array, inlier_array = ret.get_ellipse_model_ransac(
                peak_array, xf=200, yf=210, rf_lim=20,
    ...
    def test_residual_threshold(self):
        ...
        ellipse_array0, inlier_array0 = ret.get_ellipse_model_ransac(
                peak_array, xf=100, yf=100, semi_len_min=85, semi_len_max=95,
    ...
    def test_no_values_out_of_bounds(self):
        ...
        ellipse_array, inlier_array = ret.get_ellipse_model_ransac(
                peak_array, xf=xf, yf=yf, rf_lim=rf_lim,
...
def test_full_ellipse_ransac_processing():
    ...
    ellipse_array, inlier_array = ret.get_ellipse_model_ransac(
            peak_array, yf=yf, xf=xf, rf_lim=15,
            semi_len_min=min(a, b) - 5, semi_len_max=max(a, b) + 5,
            semi_len_ratio_lim=5, max_trails=50, min_samples=10)
