...
class Diffraction2D(Signal2D, CommonDiffraction):
    ...
    def get_seperate(
        ...
        **kwargs,
        ...
        """Separate bragg signal from powder/amorphous signal using azimuthal
         integration, median filering and projected back before subtraction.
