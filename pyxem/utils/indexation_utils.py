...
def correlate_library(image, library, n_largest, method, mask):
    ...
    method : str
        Name of method used to compute correlation between templates and diffraction patterns. Can be
        zero_mean_normalized_correlation, normalized_cross_correlation, sum_absolute_differences,
        normalized_sum_absolute_differences, sum_squared_differences, 
        normalized_sum_squared_differences, full_frame_correlation,. (ADDED in pyxem 0.11.0)
    mask : bool
        A mask for navigation axes. 1 indicates positions to be indexed.
