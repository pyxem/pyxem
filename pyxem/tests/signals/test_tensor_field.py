...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            np.array([[1.02, -0.013, 0.0], [-0.013, 0.98, 0.0], [0.0, 0.0, 1.0]]),
        ),
    ],
)
...
@pytest.mark.parametrize(
    "dgm, rotation_map, distortion_map",
    [
        (
            ...
            np.array(
                [
                    [
                        [[1.02, -0.013, 0.0], [-0.013, 0.98, 0.0], [0.0, 0.0, 1.0]],
                        [[1.02, -0.013, 0.0], [-0.013, 0.98, 0.0], [0.0, 0.0, 1.0]],
                    ],
                    [
                        [[1.02, -0.013, 0.0], [-0.013, 0.98, 0.0], [0.0, 0.0, 1.0]],
...
def test_map_polar_decomposition(dgm, rotation_map, distortion_map):
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            np.array(
                [
                    [[-0.01960785, -0.01960785], [-0.01960785, -0.01960785]],
                    [[0.02040816, 0.02040816], [0.02040816, 0.02040816]],
                    [[-0.01299999, -0.01299999], [-0.01299999, -0.01299999]],
                    [[-0.26179939, -0.26179939], [-0.26179939, -0.26179939]],
                ]
            ),
        ),
    ],
