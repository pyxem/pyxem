...
def test_damp_exponential(RedIntData):
    ...
    compare = np.array([[[1.00000000e+00, 3.67879441e-01, 1.83156389e-02, 1.23409804e-04,
                        ...
                        [[3.00000000e+00, 1.10363832e+00, 5.49469167e-02, 3.70229412e-04,
                         ...
                         [4.00000000e+00, 1.47151776e+00, 7.32625556e-02, 4.93639216e-04,
                          4.50140699e-07, 5.55517755e-11, 9.27809132e-16, 2.09715427e-21,
                          6.41524356e-28, 2.65587088e-35]]])
...
def test_damp_lorch(RedIntData):
    ...
    compare = np.array([[[0., 0.98363164, 0.93548928, 0.85839369, 0.75682673,
                        ...
                        [[0., 2.95089493, 2.80646785, 2.57518107, 2.27048019,
                         ...
                         [0., 3.93452656, 3.74195712, 3.43357476, 3.02730692,
                          2.54647908, 2.0182046 , 1.47153204, 0.93548928, 0.4371696 ]]])
    assert np.allclose(ri, compare)
...
def test_damp_updated_lorch(RedIntData):
    ...
    compare = np.array([[[0., 0.99016512, 0.96107415, 0.91394558, 0.85073648,
                        ...
                        [[0., 2.97049536, 2.88322246, 2.74183673, 2.55220944,
                         ...
                         [0., 3.96066048, 3.8442966 , 3.65578232, 3.40294592,
                          3.09614732, 2.74772292, 2.3713332 , 1.98125212, 1.5916416 ]]])
    assert np.allclose(ri, compare)
...
def test_damp_low_q_region_erfc(RedIntData):
    ...
    compare = np.array([[[0.03299603, 1., 1., 1., 1.,
                          1., 1., 1., 1., 1.],
                         [0.06599206, 2., 2., 2., 2.,
                          2., 2., 2., 2., 2.]],
...
def test_multiple_scatter_correction(RedIntData):
    ...
    compare = np.array([[[1., 0.14216084, -0.10154346, -0.06092608,
                        ...
                        [[3., 0.42648258, -0.30463036, -0.18277824,
                         ...
                         [4.,  0.56864336, -0.40617384, -0.24370432,
                          0.1462226, 0.26320064,  0.01624696, -0.2761982,
                          0.11372868,  2.32331436]]])
    assert np.allclose(ri, compare)
