...
def variance_generator():
    diffraction_pattern = ElectronDiffraction2D(np.array(
...
class TestVarianceGenerator:
    ...
    def test_get_diffraction_variance(
        ...
        mean_dp = np.array(
            ...
            [0.5875, 0.5075, 0.4825, 0.475 , 0.4125, 0.725 , 0.53  , 0.4275]]).reshape(8, 8)
        meansq_dp = np.array(
            [[0.37395 , 0.30455 , 0.345475, 0.311925, 0.53905 , 0.13485 ,
            0.52095 , 0.400125],
            [0.27975 , 0.387275, 0.01945 , 0.36365 , 0.03895 , 0.21995 ,
            0.09045 , 0.154225],
            [0.32825 , 0.412725, 0.326975, 0.449175, 0.20705 , 0.34915 ,
            0.050025, 0.107525],
            [0.45825 , 0.282375, 0.20145 , 0.67705 , 0.399825, 0.493025,
            0.375375, 0.30195 ],
            [0.233775, 0.361175, 0.3989  , 0.454775, 0.439125, 0.38445 ,
            0.52965 , 0.40045 ],
            [0.488175, 0.24635 , 0.472825, 0.35    , 0.461275, 0.306125,
            0.019525, 0.401725],
            [0.62355 , 0.064425, 0.3697  , 0.05265 , 0.47075 , 0.212875,
            0.2721  , 0.1716  ],
            [0.430275, 0.341575, 0.264825, 0.28025 , 0.267525, 0.54245 ,
            0.34575 , 0.258375]]).reshape(8, 8)
        var_dp = np.array(
            [[0.25898493, 0.06402306, 0.76437167, 0.10004629, 0.0398341 ,
            0.99482249, 0.03342591, 0.58461424],
            [0.26641014, 0.16122262, 0.76417234, 0.09988658, 0.34775087,
            0.48389273, 0.19603306, 0.20670937],
            [0.12568587, 0.37686871, 0.34803783, 0.07136149, 0.26230758,
            0.54747922, 0.28248678, 0.56045351],
            [0.15457294, 0.37907878, 0.55439815, 0.03193111, 0.33383374,
            0.53086611, 0.42914932, 0.16089965],
            [0.1939098 , 0.12146558, 0.18579073, 0.27385725, 0.11522039,
            0.36863653, 0.05068439, 0.34820301],
            [0.41435944, 0.09185596, 0.14539206, 0.15702479, 0.31396322,
            0.28809993, 0.41421458, 0.24737526],
            [0.03816857, 0.30135084, 0.15811732, 0.19387755, 0.35234128,
            0.13802666, 0.18098958, 0.40081633],
            [0.24660933, 0.32621515, 0.13753389, 0.24210526, 0.5722314 ,
            0.03200951, 0.23086508, 0.41376834]]).reshape(8,8)
    ...
    def test_get_image_variance(
        ...
        mean_im = np.array([[0.51765625, 0.504375  ],
                            [0.47625   , 0.47125   ]]).reshape(2, 2)
