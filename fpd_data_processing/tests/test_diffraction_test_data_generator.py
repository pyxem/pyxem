...
class test_diffraction_test_data_genrator(unittest.TestCase):
    ...
    def test_radius(self):
        r = 20
        x0, y0 = 0, 0
        ring_1 = TestData.TestData(size_x=100, size_y=100, default=False, blur=False, downscale=False)
        ...
        x0, y0 = 100, 100
        ring_2 = TestData.TestData(size_x=100, size_y=100, default=False, blur=False, downscale=False)
